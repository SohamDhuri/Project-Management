                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className="w-full px-3 py-2 rounded bg-white dark:bg-zinc-900 border border-gray-300 dark:border-zinc-700 mt-1 text-gray-900 dark:text-zinc-200 text-sm"
                            required
                        />
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full px-3 py-2 rounded bg-white dark:bg-zinc-900 border border-gray-300 dark:border-zinc-700 mt-1 text-gray-900 dark:text-zinc-200 text-sm h-20"
                        />
                    </div>
                        ...
                        {formData.team_members.length > 0 && (
                            <div className="flex flex-wrap gap-2 mt-2">
                                {formData.team_members.map((email) => (
                                    <div
                                        key={email}
                                        className="flex items-center gap-1 bg-blue-100 dark:bg-blue-500/20 text-blue-700 dark:text-blue-400 px-2 py-1 rounded-md text-sm"
                                    >
                                        {email}
                                        <button
                                            type="button"
                                            onClick={() => removeTeamMember(email)}
                                            className="ml-1 hover:bg-blue-200 dark:hover:bg-blue-500/30 rounded"
                                        >
                    ...
                    <div className="flex justify-end gap-3 pt-2 text-sm">
                        <button
                            type="button"
                            onClick={() => setIsDialogOpen(false)}
                            className="px-4 py-2 rounded border border-gray-300 dark:border-zinc-700 hover:bg-gray-100 dark:hover:bg-zinc-800"
                        >
                            Cancel
                        </button>
